...
//Profile 1 (Speed Profile) //Left-most couple
String Profile_1_Stages[5] = {"A", "C", "A"};
float Profile_1_Setpoints[5] = {0.4, 0.4, 0};
float Profile_1_Timings[5] = {1, 5, 2};

//Profile 2 (Speed Profile) //Centre couple
String Profile_2_Stages[5] = {"A", "C", "A"};
float Profile_2_Setpoints[5] = {0.45, 0.45, 0};
float Profile_2_Timings[5] = {6, 25, 5};

//Profile 3 (Speed Profile) //Right-most couple
String Profile_3_Stages[4] = {"A", "C", "A", "C"};
float Profile_3_Setpoints[4] = {0.5, 0.5, 0, 0};
float Profile_3_Timings[4] = {1, 2, 1, 1};

//Profile 4 (Speed Profile) //Viessman Beer Keg Tapper
String Profile_4_Stages[1] = {"C"};
float Profile_4_Setpoints[1] = {0.75};
float Profile_4_Timings[1] = {0};

//Profile 5 (Speed Profile) //Viessman Beer Drinkers
String Profile_5_Stages[1] = {"C"};
float Profile_5_Setpoints[1] = {0.75};
...
JOURNEY_CONFIGURATION Journey_1 {"Motor_1_Direction", no_servo, APIN1, 0, 0, 0, 12, 0, 0, 0, 0, Profile_1_Stages, Profile_1_Setpoints, Profile_1_Timings, true,3}; //Left-most couple
JOURNEY_CONFIGURATION Journey_2 {"Motor_1_Direction", no_servo, BPIN1, 0, 0, 0, 12, 0, 0, 0, 0, Profile_2_Stages, Profile_2_Setpoints, Profile_2_Timings, true,3}; //Middle couple
JOURNEY_CONFIGURATION Journey_3 {"Motor_1_Direction", no_servo, BPIN2, 0, 0, 0, 12, 0, 0, 0, 0, Profile_3_Stages, Profile_3_Setpoints, Profile_3_Timings, true,4}; //Right-most couple

// These two can probably be combined to one pin? 
JOURNEY_CONFIGURATION Journey_4 {"Motor_1_Direction", no_servo, DPIN1, 0, 0, 0, 12, 0, 0, 0, 0, Profile_4_Stages, Profile_4_Setpoints, Profile_4_Timings, true,1}; //Viessmann Beer Keg Tapper
JOURNEY_CONFIGURATION Journey_5 {"Motor_1_Direction", no_servo, DPIN2, 0, 0, 0, 12, 0, 0, 0, 0, Profile_5_Stages, Profile_5_Setpoints, Profile_5_Timings, true,1}; //Viessmann Beer Drinkers
